...
def train_output(content, style, n_fft=N_FFT, n_filters=N_FILTERS, filter_width=FILTER_WIDTH, reduce_factor=1):
    ...
    result, initial = train(n_samples, n_channels, model, content_features, style_gram)
...
if __name__ == '__main__':
   ...
   # n_filter_values = [4096]
   # hyperparameter_grid_search("op_cancelled.wav", "british.wav", fft_values, filter_size_values, n_filter_values)
